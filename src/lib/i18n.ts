    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ['30 кунлик доступ', 'Барча тестлар (1300+ савол)', 'Видеодарслар', 'Мнемоника усули'],
        },
      ],
      cta: "Танлаш",
    },
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ['Доступ 30 дней', 'Все тесты (1300+ вопросов)', 'Видеоуроки', 'Метод мнемоники'],
        },
      ],
      cta: 'Выбрать',
    },
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ['30 days of access', 'All tests (1,300+ questions)', 'Video lessons', 'Mnemonic method'],
        },
      ],
      cta: 'Choose',
    },
