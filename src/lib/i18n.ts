      ...
      plans: [
        {
          ...
          features: ['14 кунлик доступ', 'Барча тестлар (1300+ савол)', 'Якуний тест'],
        ...
        },
        {
          ...
          price: '70 000 сўм',
          desc: 'Фақат тестлар (видеосиз)',
          features: ['30 кунлик доступ', 'Барча тестлар (1300+ савол)', 'Якуний тест'],
          excluded: ['Видеодарслар'],
          highlight: true,
        },
        {
          name: 'Макс',
          price: '499 000 сўм',
          desc: 'Тестлар + видеодарслар',
          features: ['30 кунлик доступ', 'Барча тестлар (1300+ савол)', 'Якуний тест', 'Видеодарслар', 'Мнемоника усули'],
        },
      ],
      cta: "Танлаш",
    },
        ...
        sections: [
          ...
          },
          {
            ...
            body: [
              ...
              'Хизматлар қуйидаги тарифлардан бирига мувофиқ кўрсатилади: Стандарт, Про, Макс — ҳар бир тарифнинг таркиби ва нархи тўлов пайтида сайтда кўрсатилади.',
            ],
          },
          {
            heading: '3. Нарх ва тўлов тартиби',
            body: [
              'Тарифлар нархи: Стандарт — 45 000 сўм, Про — 70 000 сўм, Макс — 499 000 сўм.',
              ...
              'Фойдаланиш муддати танланган тарифга боғлиқ: Стандарт — 14 кун, Про ва Макс — 30 кун. Стандарт ва Про тарифларида фақат тестлар, Макс тарифида тестлар ва видеодарслар мавжуд.',
            ],
          },
          {
      ...
      plans: [
        {
          ...
          features: ['Доступ 14 дней', 'Все тесты (1300+ вопросов)', 'Финальный тест'],
          excluded: ['Видеоуроки'],
        },
        {
          name: 'Про',
          price: '70 000 сум',
          desc: 'Только тесты (без видео)',
          features: ['Доступ 30 дней', 'Все тесты (1300+ вопросов)', 'Финальный тест'],
          excluded: ['Видеоуроки'],
          highlight: true,
        },
        {
          name: 'Макс',
          price: '499 000 сум',
          desc: 'Тесты + видеоуроки',
          features: ['Доступ 30 дней', 'Все тесты (1300+ вопросов)', 'Финальный тест', 'Видеоуроки', 'Метод мнемоники'],
        },
      ],
      cta: 'Выбрать',
    },
        ...
        sections: [
          ...
          },
          {
            ...
            body: [
              ...
              'Услуги оказываются по одному из тарифов: Стандарт, Про, Макс — состав и стоимость каждого тарифа указаны на сайте на момент оплаты.',
            ],
          },
          {
            heading: '3. Стоимость и порядок оплаты',
            body: [
              'Стоимость тарифов: Стандарт — 45 000 сум, Про — 70 000 сум, Макс — 499 000 сум.',
              ...
              'Срок доступа зависит от выбранного тарифа: Стандарт — 14 дней, Про и Макс — 30 дней. В тарифах Стандарт и Про доступны только тесты, в тарифе Макс — тесты и видеоуроки.',
            ],
          },
          {
      ...
      plans: [
        {
          ...
          features: ['14 days of access', 'All tests (1,300+ questions)', 'Final test'],
        ...
        },
        {
          ...
          price: '70,000 UZS',
          desc: 'Tests only (no video)',
          features: ['30 days of access', 'All tests (1,300+ questions)', 'Final test'],
          excluded: ['Video lessons'],
          highlight: true,
        },
        {
          name: 'Max',
          price: '499,000 UZS',
          desc: 'Tests + video lessons',
          features: ['30 days of access', 'All tests (1,300+ questions)', 'Final test', 'Video lessons', 'Mnemonic method'],
        },
      ],
      cta: 'Choose',
    },
        ...
        sections: [
          ...
          },
          {
            ...
            body: [
              ...
              'Services are provided under one of the following plans: Standard, Pro, Max — the content and price of each plan are shown on the site at the time of payment.',
            ],
          },
          {
            heading: '3. Price and payment procedure',
            body: [
              'Plan prices: Standard — 45,000 UZS, Pro — 70,000 UZS, Max — 499,000 UZS.',
              ...
              'The access period depends on the chosen plan: Standard — 14 days, Pro and Max — 30 days. The Standard and Pro plans include tests only; the Max plan includes tests and video lessons.',
            ],
          },
          {
            heading: '4. Refunds',
